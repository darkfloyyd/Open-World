 ...
 * Text Domain:       open-world-translate
 */
if (!defined('ABSPATH')) {
	exit;
}
...
add_action('plugins_loaded', function (): void {
	...
	add_action('wp_ajax_ow_inline_google_free_single', [$inline, 'ajax_google_free_single']);

	// Add Settings link on Plugins page
	add_filter('plugin_action_links_' . plugin_basename(__FILE__), function ($links) {
		$settings_link = '<a href="' . admin_url('admin.php?page=ow-settings') . '">' . __('Settings', 'open-world-translate') . '</a>';
